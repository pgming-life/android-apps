...
import com.jackbee.earthfree.BaseConfigChooser.ComponentSizeChooser;
import com.jackbee.earthfree.BaseConfigChooser.SimpleEGLConfigChooser;
...
//private static final String TAG = "GLWallpaperService";
    ...
    public class GLEngine extends Engine {
        ...
        private MotionCallback  _motionCallback;

        public GLEngine() {
            super();
        }

        public void setMotionCallback (MotionCallback motionCallback) {
            _motionCallback = motionCallback;
        }

        @Override
        public void onTouchEvent(MotionEvent event) {
            _motionCallback.runMotionCallback(event);
