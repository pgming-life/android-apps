package com.jackbee.earthfree.settings;

import com.jackbee.earthfree.EarthLiveWallpaperFree;
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    try {
                        ...
                        if(Build.VERSION.SDK_INT > 15) {
                            ...
                            String p = EarthLiveWallpaperFree.class.getPackage().getName();
                            String c = EarthLiveWallpaperFree.class.getCanonicalName();
...
//********** OTHER
            ...
            valuationLink.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {
                    Uri uriValuation = Uri.parse("https://play.google.com/store/apps/details?id=com.jackbee.earthfree");
